...
> (bản dịch nội bộ tổ chức — `docs/whitepaper-ai-dlc-vi.md` trong repo plugin). Mâu thuẫn → white paper thắng.
...
lý do + "file vừa đổi N phút trước". Ca gốc (PILOT · `HOF-0039` · 13/08): agent ghi file lúc 18:13 nhưng khai
...
5. **"Đã gửi" không có nghĩa là "có người nhận".** `SendMessage` báo thành công khi **ghi được file hộp
   thư** — kể cả khi teammate đó chưa bao giờ spawn. Ca thật (PILOT · 13/08): 5 lần spawn hỏng vì tmux
