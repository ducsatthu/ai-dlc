...
(RV đã hứa mà chưa có vẫn là `unfulfilled`, ví dụ ca RV-019/RV-020 của PILOT). Áp tầng từ intent kế.
...
Nguồn: retro INT-001 của dự án PILOT — `LL-001` + `LL-002` (Gate G · DEC-0027), thêm `LL-003` (chưa qua Gate G,
