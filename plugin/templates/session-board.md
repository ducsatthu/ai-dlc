...
| Vị trí (agent) | HOF | Phạm vi | Nhận lúc | Đang chờ gì |
|---|---|---|---|---|
| — | — | — | — | — |

## Đã giao, chưa ai nhận (status `open`)

| Giao cho | HOF | Phạm vi | Giao lúc | Chặn bởi |
|---|---|---|---|---|
| — | — | — | — | — |

## Trả lại / cần người xử lý (status `returned`)

| Từ | HOF | Phạm vi | Thiếu gì |
|---|---|---|---|
| — | — | — | — |

## Vừa đóng (5 gần nhất)

| HOF | Vị trí | Phạm vi | Đóng lúc |
|---|---|---|---|
| — | — | — | — |
