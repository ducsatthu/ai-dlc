...
- Unit thiếu `releasable`/`session_fit`, hoặc ước lượng không có breakdown, hoặc breakdown không có căn cứ bằng con số thật.
...
- Viết `session_fit: "vừa một phiên"` mà không có con số — reviewer sẽ bắt, và đó là escalation về chất lượng kế hoạch.
