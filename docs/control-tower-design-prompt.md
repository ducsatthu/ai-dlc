...
Khái niệm chính:
- **Intent** (`INT-001`) — một yêu cầu lớn, ví dụ "Triển khai Phase 2 cho PILOT"
...
- Intent: `INT-001 — Triển khai Phase 2 PILOT (Release + Milestone + Backlog)` — đang ở stage 5, Gate D mở
