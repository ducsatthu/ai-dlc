...
window.CT_DIAGRAMS.hierarchy = `flowchart TB
  ...
  P["<b>Dự án</b> · demo-project"]
  CR --> P
  P --> I1["<b>INT-001</b> · Intent<br/>Phase 2 PILOT — phát triển tiếp"]
...
(function () {
  ...
  function Sidebar({
    ...
    }, /*#__PURE__*/React.createElement("div", null, "supervisor \xB7 Human"), /*#__PURE__*/React.createElement("div", null, "demo-project")));
  }
  function TopBar({
    title,
    subtitle,
...
try { (() => {
// Sample data — taken verbatim from docs/control-tower-design-prompt.md and docs/simulation-phase2-pilot.html
window.CT_DATA = {
  ...
  intents: [{
    id: 'INT-001',
    name: 'Triển khai Phase 2 PILOT (Release + Milestone + Backlog)',
    stage: 5,
    gate: 'D',
    holder: 'unit-planner',
...
(function () {
  ...
  function BlueprintDoc() {
    return /*#__PURE__*/React.createElement("div", {
      ...
      variant: "inline"
    }, "/intent"), " cho PILOT Phase 2 \u2014 d\u1EEBng \u1EDF Gate A ch\u1EDD anh/ch\u1ECB.")));
  }
  const rootEl = document.getElementById('root');
