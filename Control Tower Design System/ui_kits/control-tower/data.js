...
window.CT_DATA = {
  ...
  intents: [
    { id: 'INT-001', name: 'Triển khai Phase 2 PILOT (Release + Milestone + Backlog)', stage: 5, gate: 'D', holder: 'unit-planner', brownfield: 'Add feature', doc: 'wiki/docs/phase2-screens.md', owner: 'PMO Túy', updated: '14:22 hôm nay', units: [4, 0], risk: 'high' },
  ...
  trace: [
    ...
    { kind: 'intent', id: 'INT-001', note: 'Triển khai Phase 2 PILOT' }
  ],
  reviews: [
