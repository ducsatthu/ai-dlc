    ...
    <div style={{ maxWidth: 1100, margin: '0 auto', padding: '48px 24px 96px' }}>
      <header style={{ borderBottom: '2px solid var(--ink)', paddingBottom: 24, marginBottom: 8 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', gap: 16, flexWrap: 'wrap' }}>
          <div style={{ fontFamily: 'var(--mono)', fontSize: 12, letterSpacing: '0.14em', textTransform: 'uppercase', color: 'var(--muted)' }}>AI-DLC · Engineering process</div>
      ...
      <section style={{ marginTop: 64 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1.1fr) minmax(280px,1fr)', gap: 16, marginTop: 20 }}>
          ...
          <Panel title="Pipeline board" pad={false}>
            <PipelineRow id="INT-001" name="Phase 2 PILOT" current={5} gate="D" holder="unit-planner" />
      ...
      <div style={{ marginTop: 56, border: '2px solid var(--accent)', borderRadius: 12, background: 'var(--accent-bg)', padding: '24px 28px' }}>
        ...
        <p style={{ marginBottom: 6, maxWidth: '68ch' }}>Nếu bản thiết kế này đúng ý, bước tiếp theo là scaffold bộ agent rồi chạy thật <IdCode variant="inline">/intent</IdCode> cho PILOT Phase 2 — dừng ở Gate A chờ anh/chị.</p>
      </div>
    </div>
  );
}
